        ...
        <footer className="border-t border-border py-12 bg-card text-foreground">
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-2 md:grid-cols-6 gap-12 mb-12">
                    <div className="col-span-2">
                        <div className="flex items-center gap-2 mb-4">
                            <img src={logo} alt="PeakSEO AI Logo" className="w-6 h-6" />
                            <span className="text-xl">PeakSEO AI</span>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            <a href="https://x.com/daynanf23" className="text-muted-foreground hover:text-primary transition-colors">
                                <SiX size={20} />
                            </a>
                ...
                <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} PeakSEO AI. All rights reserved.</p>
